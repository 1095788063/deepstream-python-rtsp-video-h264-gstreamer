...
def main(rtsp):
    ...
    decodebin = Gst.ElementFactory.make("avdec_h265", "decodea")
    ...
    #拼接
    queue1.link(depay)
    depay.link(h265parser)
    h265parser.link(decodebin)
    decodebin.link(sink)
...
if __name__ == '__main__':
    ...
    rstp = 'rtsp://admin:123456789a@192.168.2.3:554/h265/ch1/main/av_stream'
    main(rstp)
    sys.exit()